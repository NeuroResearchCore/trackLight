function  peak = Mark3P_RegressionTracking_part1(clusterRe, iValidIndex, fs, AlgoParam)
%
...
load('./icpRegModel2017.mat');
iValidIndex = 1;
fs = 400;
load('E:\code - Copy\trackLight-master\trackLight-master\data\ICPdatabase.mat')
clusterRe = vv;
AlgoParam.P3Proc = @DetectSPntByIntersection;
AlgoParam.AssignPeakToCandidate = 0;
len = 400;%partCodeRun();% load(AlgoParam.regFileName, 'model', 'options', 'len');  %wmm
