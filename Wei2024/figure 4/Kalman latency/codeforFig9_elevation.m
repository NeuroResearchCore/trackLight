...
%t1 = annotation('textbox',[0.23 0.835160239266044 0.323214276613934 0.0630952369244326],'string','P1 elevation with 5% noise','edgecolor','none','fitboxtotext','on');
...
set(h,'Units','Inches');
 ...
 print(h, 'KalmanElevation3','-dpng','-r300');
 print(h, 'KalmanElevation3','-deps2c','-r300')
 close;
