...
for noiseLevel=0:3
    for peak=1:3
        ...
        rmseBayesianTracking(peak, noiseLevel+1) = sqrt(sse ./ numel(sseI));
    end
end
save('D:\Fabien\paperMiaomiaoLatest\allfigures\figures\common\rmse_Latency_BayesianTracking2.mat', "rmseBayesianTracking");