function [avgPulses, avgPulsesAUC, pulsesTime, mICP] = getBeatClusters(fileName, settings)
...
[avgPulses, avgPulsesAUC, pulsesTime, mICP] = clusterPulses(clusters, relativeTime, settings);
