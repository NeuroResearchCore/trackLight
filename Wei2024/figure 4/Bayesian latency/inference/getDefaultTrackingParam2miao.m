...
if(~AlgoParam.parametricModel) 
    ...
    AlgoParam.temporalSigmaL = .1;   % should be equal to var(model.temporalmodel.kde).2
    AlgoParam.temporalSigmaE = .1;

    AlgoParam.observationSigmaL = 30; %
    AlgoParam.observationSigmaE = 4; 
else
    AlgoParam.observationSigmaL = 6.25; 
